// const username = "loveBirds         ";

// String.prototype.pss = function () {
//     console.log(this.trim().length);
// };
// username.pss();

// const arr = ["hello", "hiiii", "bye"];

// Array.prototype.ass = function (e) {
...
createUser.prototype.increment = function () {
  this.score++; // this: jisne bhi bulaya hai uske paas jaaaoooo
};
